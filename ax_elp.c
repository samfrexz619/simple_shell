...
void aux_help_env(void)
{
	...
	help = "Print the env of the shell.\n";
	write(STDOUT_FILENO, help, _strlen(help));
...
void aux_help_setenv(void)
{
	...
	help = "int replace)\n\t";
	write(STDOUT_FILENO, help, _strlen(help));
	help = "Add a new definition to the env\n";
	write(STDOUT_FILENO, help, _strlen(help));
}
/**
...
void aux_help_unsetenv(void)
{
	...
	write(STDOUT_FILENO, help, _strlen(help));
	help = "Remove an entry completely from the env\n";
	write(STDOUT_FILENO, help, _strlen(help));
}
/**
...
void aux_help_exit(void)
{
	...
	write(STDOUT_FILENO, help, _strlen(help));
	help = "status is that of the last cmd executed\n";
	write(STDOUT_FILENO, help, _strlen(help));
}
